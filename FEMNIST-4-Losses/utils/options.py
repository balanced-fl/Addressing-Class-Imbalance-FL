...
def args_parser():
    ...
    parser.add_argument('--loss', type=str, default='ce', help="loss of network")
    parser.add_argument('--ratio', type=float, default=0.01, help="ratio of minor class")
    ...
    parser.add_argument('--iid', type=int, default=4, help='whether i.i.d or not')
    ...
    torch.cuda.manual_seed_all(args.seed)  # setting random seed for GPU
    return args
